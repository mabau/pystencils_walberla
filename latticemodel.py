...
def generateLatticeModel(latticeModelName=None, optimizationParams={}, refinementLevelScaling=None, **kwargs):
    """
    ...
    :param refinementLevelScaling: dict from parameter symbol (e.g. relaxationRate, force parameter) to an expression
    ...
    context = {
        ...
        'refinementLevelScaling': refinementLevelScaling,
...
if __name__ == '__main__':
    ...
    header, cpp = generateLatticeModel(latticeModelName='GenLM', method='srt', stencil='D3Q19',
                                       ...
                                       refinementLevelScaling=scaling)
